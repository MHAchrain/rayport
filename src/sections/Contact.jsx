  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[88rem]">
        <div className="grid min-w-0 gap-6 xl:grid-cols-[1.05fr_0.95fr] xl:items-stretch">
          <article className="flex min-w-0 flex-col justify-between rounded-xl border border-white/10 bg-[#0b0909]/90 p-5 shadow-2xl shadow-black/30 backdrop-blur-md sm:p-8 lg:min-h-120 lg:p-10">
            ...
            <div className="mt-10 grid min-w-0 gap-4 md:grid-cols-2">
              <a
                ...
                className="group flex min-w-0 items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4 transition duration-300 hover:-translate-y-1 hover:border-primary-800/80 hover:bg-white/8 focus:outline-none focus-visible:border-primary-800 focus-visible:ring-2 focus-visible:ring-primary-800"
              >
              ...
              <div className="flex min-w-0 items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4">
            ...
            {socials.map((social) => {
              ...
              return (
                <a
                  key={social.label}
                  href={social.href}
                  className="group flex min-w-0 items-center justify-between gap-4 rounded-xl border border-white/10 bg-[#0b0909]/90 p-5 shadow-xl shadow-black/20 backdrop-blur-md transition duration-300 hover:-translate-y-1.5 hover:border-primary-800/80 hover:bg-[#0f0c0c] focus:outline-none focus-visible:border-primary-800 focus-visible:ring-2 focus-visible:ring-primary-800"
