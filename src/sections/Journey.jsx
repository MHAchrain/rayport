...
export default function Journey() {
  return (
    <section
      id="journey"
      className="relative isolate scroll-mt-24 overflow-hidden bg-background px-6 py-10"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
          ...
          <div className="relative">
            <div className="absolute bottom-8 left-2 top-8 hidden w-px bg-linear-to-b from-primary-900 via-white/15 to-primary-900/20 sm:block" />
            ...
            <div className="grid gap-5">
              {experiences.map((item, index) => (
                <article
                  key={item.title}
                  tabIndex={0}
                  className="group relative rounded-xl border border-white/10 bg-[#0b0909]/90 p-5 shadow-2xl shadow-black/25 backdrop-blur-md transition duration-300 ease-out hover:-translate-y-1.5 hover:border-primary-800/80 hover:bg-[#0f0c0c] hover:shadow-primary-300/20 focus:outline-none focus-visible:-translate-y-1.5 focus-visible:border-primary-800 focus-visible:ring-2 focus-visible:ring-primary-800 sm:ml-14 sm:p-6"
                >
                  <div className="absolute left-0 top-7 hidden h-4 w-4 translate-x-[-3.55rem] rounded-full border border-primary-800 bg-background shadow-[0_0_0_8px_rgba(61,0,0,0.45),0_0_24px_rgba(255,31,31,0.45)] transition duration-300 group-hover:scale-125 group-hover:bg-primary-800 sm:block" />
